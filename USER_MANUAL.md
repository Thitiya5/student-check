...
| **รายงาน** | แถบล่าง → รายงาน | รายวัน · รายสัปดาห์ · รายเดือน · ส่งออก PDF (ปุ่มเดียว) |
...
ใช้ปุ่ม **ส่งออก PDF** ปุ่มเดียวด้านล่างรายงาน — ระบบเลือกรูปแบบไฟล์ให้ตามโหมดและสิทธิ์:

| โหมด | เงื่อนไข | ไฟล์ PDF ที่ได้ |
|------|----------|----------------|
| **รายวัน** | ไม่เลือกห้อง (ผู้ดูแลระบบ) | สรุปรายห้องทั้งโรงเรียน |
| **รายวัน** | เลือก LEVEL + ROOM | รายชื่อห้อง (เลขที่ · รายชื่อนักเรียน · สถานะ) — ครูประจำชั้นห้องตนเอง |
| **รายเดือน** | เลือก LEVEL + ROOM | **ตารางรายเดือน** ชื่อ × วัน 1–31 · % มา · คะแนนพฤติกรรม |
| **รายสัปดาห์ / ภาคเรียน** | ตามสิทธิ์ | รายงานสรุปตัวเลขและตารางช่วงเวลา |

**ขั้นตอน**

1. เลือก **โหมดรายงาน** · **วันที่/เดือน** · **LEVEL + ROOM** (รายเดือนและรายวันแบบรายห้องต้องเลือกห้อง)
2. รอระบบโหลดข้อมูลบนหน้าจอ
3. เลื่อนลงล่าง กด **ส่งออก PDF** — ไฟล์จะดาวน์โหลดอัตโนมัติ
...
- ครูประจำชั้นส่งออก PDF รายห้องได้เฉพาะ **ห้องที่รับผิดชอบ**
- รายเดือนต้องเลือก **LEVEL และ ROOM** ก่อนส่งออก — ไม่มีปุ่ม PDF แยกอีกแล้ว
...
3. อัปเดตแอป: ปิดแล้วเปิดใหม่ (เวอร์ชัน 3.1.0 ขึ้นไปปรับเลย์เอาต์มือถือและรายงานแล้ว)
...
*เอกสารนี้จัดทำจากระบบ Student Check v3.1.0 — โรงเรียนยางตลาดวิทยาคาร · หากมีข้อเสนอแนะเพิ่มเติมในเนื้อหา แจ้งผู้ดูแลระบบหรือทีมพัฒนา*
